...
export const categories: Category[] = [
    {
        id: 'html',
        topic: 'HTML',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/html.json',
        icon: 'html5',
    },
    {
        id: 'css',
        topic: 'CSS',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/css.json',
        icon: 'css3-alt',
    },
    {
        id: 'sql',
        topic: 'SQL',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/sql.json',
        icon: 'database',
    },
    {
        id: 'javascript',
        topic: 'JavaScript',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/javascript.json',
        icon: 'js',
    },
    {
        id: 'programming',
        topic: 'Programming',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/prog.json',
        icon: 'code',
    },
    {
        id: 'ui-design',
        topic: 'UI Design',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/ui-design.json',
        icon: 'paint-brush',
    },
    {
        id: 'dsa',
        topic: 'Data Structures & Algorithms',
        url: 'https://raw.githubusercontent.com/tranducanh02/quizapp_question/main/dsa.json',
        icon: 'atom',
    },
];
    ...
    try {
        ...
        if (error || !data.length) {
            const { data, error } = await supabase
                .from('scores')
                .insert({
                    attempts: JSON.stringify([{ score: userScore, date: getCurrentDate() }]),
            ...
            const { data: updateData, error } = await supabase
                .from('scores')
                .update({
                    attempts: JSON.stringify([...data[0].attempts, { score: userScore, date: getCurrentDate() }]),
