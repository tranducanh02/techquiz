...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(stack)/completed` | `/completed` | `/(stack)/test` | `/test` | `/(stack)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/leaderboard` | `/leaderboard` | `/(tabs)/profile` | `/profile` | `/(tabs)/_layout` | `/register`;
  // prettier-ignore
